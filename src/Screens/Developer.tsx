...
const Developer = (props) => {
    ...
    const getallPostsWithToken = async () => {
        ...
        fetch(`https://graph.instagram.com/17841411232674370/media?fields=id,caption,media_url,media_type,permalink,thumbnail_url,timestamp,username,children&access_token=${IGTOKEN}`)
