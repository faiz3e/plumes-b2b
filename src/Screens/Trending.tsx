    ...
    <section className="ftco-section bg-light">
      ...
      <div className="container-fluid pt-3 mt-4">
        <div className="row">
          <div className="col-sm-12 col-md-6 col-lg ">
            <div className="product">
              <a href="#" className="img-prod">
                <img className="img-fluid" src={home_slide} alt="Colorlib Template" /></a>
          ...
          <div className="col-sm-12 col-md-6 col-lg ">
            <div className="product">
              <a href="#" className="img-prod"><img className="img-fluid" src={home_slide1} alt="Colorlib Template" /></a>
              <div className="text py-3 px-3">
                <h3><a href="#">Young Woman Wearing Dress</a></h3>
                <div className="d-flex">
                  <div className="pricing">
          ...
          <div className="col-sm-12 col-md-6 col-lg ">
            <div className="product">
              <a href="#" className="img-prod"><img className="img-fluid" src={home_slide2} alt="Colorlib Template" /></a>
              <div className="text py-3 px-3">
                <h3><a href="#">Young Woman Wearing Dress</a></h3>
                <div className="d-flex">
                  <div className="pricing">
